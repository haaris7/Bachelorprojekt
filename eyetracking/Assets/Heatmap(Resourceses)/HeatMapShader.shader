Shader "Unlit/NewUnlitShader"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float _FixationDurations[32]; //passed in array of fixation durations
            int _HitCount = 0;
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                for (float i = 0.0; i < _HitCount; i++)
                {
                    ...
                    float fixationDuration = _FixationDurations[i];

                    totalWeight += 0.5 * distsq(uv, work_pt) * pt_intensity * fixationDuration * _Strength * (1 + sin(_Time.y * _PulseSpeed));
                }
